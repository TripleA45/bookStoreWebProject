...
cartBtn = document.querySelector(".navbarElementCart");
...
function ready() {
  ...
  var addToCartButtons = document.getElementsByClassName('book_info_addToCart')
...
function purchaseClicked() {
  ...
  function addToCartClicked(event) {
    ...
    var book = button.parentElement.parentElement
    var title = book.getElementsByClassName('book_info_title')[0].innerText
    var price = book.getElementsByClassName('book_info_price')[0].innerText
    var imageSrc = book.getElementsByClassName('book_image')[0].src 
